...
from chimeras3prl.s3prl import hub as chimera_hub
from chimeras3prl.s3prl.utility.download import (
    _urls_to_filepaths as chimera_urls_to_filepaths,
)
...
class ChimeraSpeechEncoder(nn.Module):
    def __init__(
        self,
        name: str,
        pretrained: bool = False,
        ...
        **kwargs,
        ...
        # self.encoder = getattr(chimera_hub, name)().to(device)
        self.encoder = getattr(chimera_hub, name)(
            # ckpt="/work/vjsalt22/atosystem/audio-visual-ssl/chimera_ckpt/default/states-40000.ckpt",
            # model_config="/work/vjsalt22/atosystem/audio-visual-ssl/chimera_ckpt/default/config_model.yaml",
            # refresh=True
        )
        print(self.encoder)
        if hasattr(self.encoder, "get_downsample_rates"):
